...
{ 
    ...
    if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
        ...
        if ($_SESSION["type"] = "Parent"){
            $sql = "SELECT ID_parent,FirstName,LastName,Email,PhoneNum1,PhoneNum2,PhoneNum3,Address FROM parent WHERE ID_user = :id_user";
