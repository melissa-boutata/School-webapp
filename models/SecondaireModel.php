...
class SecondaireModel {

 public function __construct()
 {}

public function getSecondaireArticles()
{   
    ...
    try{
        ...
        die("ERROR: Could not connect. " . $exc->getMessage());
            ...
            $sql = "SELECT * FROM article WHERE Secondaire='Oui' ORDER BY Date DESC";
...
public function getEnsSecondaire(){

    require_once "config/config.php";
    $sql = "SELECT DISTINCT ID_ens FROM enseignement INNER JOIN classe ON enseignement.ID_classe=classe.ID_classe WHERE Cycle='Secondaire'";
